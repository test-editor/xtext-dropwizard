...
class XtextIndexModule extends AbstractModule {
	...
	override protected configure() {
		...
		// The latter is not bound directly, relying instead on SimpleResourceDescriptionsBasedContainerManager, which will
		// delegate to ProjectDescriptionBasedContainerManager only if appropriate.
		...
		binder.bind(IContainer.Manager).to(SimpleResourceDescriptionsBasedContainerManager)  
